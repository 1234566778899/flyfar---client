                ...
                <div className='box-dashboard'>
                            ...
                            !owner.test && (
                                <div>
                                    ...
                                    <div className='card-profile' style={{ background: 'black', color: 'white' }}>
                                        ...
                                        <p>Antes de comenzar con los desafíos individuales, realiza esta prueba inicial para conocer tu nivel actual en programación.</p>
                    ...
                    <div>
                        <div className="content-friends mt-4" style={{ height: '400px' }}>
                            ...
                            {
                                friends && friends.slice(0, 4).map((x, index) => (
                            ...
                            {
                                friends && friends.length > 4 && (<div className='text-center mt-3'>
