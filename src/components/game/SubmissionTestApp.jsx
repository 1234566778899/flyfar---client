...
export const SubmissionTestApp = () => {
        ...
        <div>
            <div className="container inter">
                ...
                <div className='mb-3' style={{ display: 'flex', color: '#717171', fontWeight: 'bold', alignItems: 'center' }}>
                    <span style={{ cursor: 'pointer' }} onClick={() => navigate(`/admin/test/${challengeId}`)} className='me-2'>Todos los desafios</span>
                ...
                }
                {
                    submissions.length == 0 && (<div>
                        ...
                        <div className="text-center mt-3">
                            <button className='btn-view-challenges' onClick={() => navigate(`/admin/test/${challengeId}`)}>Ver desafios</button>
                        </div>
                    </div>)
                }
            </div>
